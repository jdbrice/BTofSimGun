...
void StBTofCalibMaker::processStEvent()
{
    ...
    for(int i=0;i<nhits;i++) {
        ...
        Double_t pathLengthToUse = L;
        Double_t beta = pathLengthToUse / (tofcorr*(C_C_LIGHT/1.e9));
        ...
        pidTof->setPathLength((Float_t)pathLengthToUse ) ;
        ...
        if(mUseEventVertex) {
            ...
            if(ppidTof) {
                ...
                ppidTof->setPathLength((Float_t)pathLengthToUse ) ;
